...
async def react_agent_demo():
    ...
    print("\n" + "=" * 60)
    print("🔍 REACTAGENT - Research & Data Gathering")
    print("=" * 60)
...
async def tinycode_agent_demo():
    ...
    print("\n" + "=" * 60)
    print("🧮 TINYCODEAGENT - Deep Analysis & Computation")
    print("=" * 60)
...
async def hybrid_workflow():
    ...
    print("\n" + "=" * 60)
    print("🚀 HYBRID WORKFLOW - Complete Analysis Pipeline")
    print("=" * 60)
...
async def main():
    ...
    print("🤖 tinyAgent Hybrid Demonstration")
    print("Combining ReactAgent (research) + TinyCodeAgent (analysis)")

    try:
        # Individual demos
        react_result = await react_agent_demo()
        print(f"\n✅ ReactAgent completed in {react_result.duration_seconds:.2f}s")

        code_result = await tinycode_agent_demo()
        print(f"\n✅ TinyCodeAgent completed in {code_result.duration_seconds:.2f}s")
