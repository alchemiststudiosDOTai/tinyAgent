...
Alchemy provider resolves API keys from provider-specific env vars (e.g., `OPENAI_API_KEY`, `OPENROUTER_API_KEY`, `MINIMAX_API_KEY`, `MINIMAX_CN_API_KEY`). See `alchemy_provider.py:_PROVIDER_API_KEY_ENV`.
