...
result = agent.run(
    ...
    template_path="{{default}}"  # References core/prompts/default.md
)
```
...
result = agent.run(
    ...
    template_path="{{weather}}",  # References core/prompts/weather.md
    variables=variables
)
```
...
4. Be placed in the `core/prompts/` directory
